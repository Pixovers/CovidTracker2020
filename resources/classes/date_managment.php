<?php
    ...
    /*
     *  Classe:         DateManagment
     *  Descrizione:    Gestione di date
     */
    class DateManagment {
        ...
        public static function intervalsFromDate( $start_date, $interval_unit ) {
        ...
        public static function monthsListFromDate( $start_date ) {
